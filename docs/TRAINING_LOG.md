...
Plots: [fold1](../results/1dnnfabelo_ce_bal_fold1_vpfabelo_curves.png), [fold2](../results/1dnnfabelo_ce_bal_fold2_vpfabelo_curves.png), [fold3](../results/1dnnfabelo_ce_bal_fold3_vpfabelo_curves.png), [fold4](../results/1dnnfabelo_ce_bal_fold4_vpfabelo_curves.png) ,[fold5](../results/1dnnfabelo_ce_bal_fold5_vpfabelo_curves.png)
...
Plots: [fold1](../results/1dnnfabelo_ufl_bal_fold1_vpfabelo_curves.png), [fold2](../results/1dnnfabelo_ufl_bal_fold2_vpfabelo_curves.png), [fold3](../results/1dnnfabelo_ufl_bal_fold3_vpfabelo_curves.png), [fold4](../results/1dnnfabelo_ufl_bal_fold4_vpfabelo_curves.png) ,[fold5](../results/1dnnfabelo_ufl_bal_fold5_vpfabelo_curves.png)
...
Plots: [fold1](../results/1dnnfabelo_fl_bal_fold1_vpfabelo_curves.png), [fold2](../results/1dnnfabelo_fl_bal_fold2_vpfabelo_curves.png), [fold3](../results/1dnnfabelo_fl_bal_fold3_vpfabelo_curves.png), [fold4](../results/1dnnfabelo_fl_bal_fold4_vpfabelo_curves.png) ,[fold5](../results/1dnnfabelo_fl_bal_fold5_vpfabelo_curves.png)
...
Plots: [fold1](../results/1dnn_ce_bal_fold1_vpfabelo_curves.png), [fold2](../results/1dnn_ce_bal_fold2_vpfabelo_curves.png), [fold3](../results/1dnn_ce_bal_fold3_vpfabelo_curves.png), [fold4](../results/1dnn_ce_bal_fold4_vpfabelo_curves.png) ,[fold5](../results/1dnn_ce_bal_fold5_vpfabelo_curves.png)
...
Plots: [fold1](../results/1dnn_ufl_bal_fold1_vpfabelo_curves.png), [fold2](../results/1dnn_ufl_bal_fold2_vpfabelo_curves.png), [fold3](../results/1dnn_ufl_bal_fold3_vpfabelo_curves.png), [fold4](../results/1dnn_ufl_bal_fold4_vpfabelo_curves.png) ,[fold5](../results/1dnn_ufl_bal_fold5_vpfabelo_curves.png)
...
| Run | Model | Loss | Bal | Status |
|---|---|---|---|---|
| 4.1 | 3D-CNN   | CE  | bal | ⏳ (pending Gate 2) |
| 4.2 | HybridSN | CE  | bal | ⏳ (pending Gate 2) |
| 4.3 | Best 3D  | UFL | bal | ⏳ (pending Gate 1) |

Gate 3 evaluated after Phase 4.

### Phase 5 — Vision Transformer (Tier 2 advanced)
